...
In this repository, sync the skill to your local skills directory with the root sync script:
...
Or copy this skill directory manually to your local skills directory:

**Windows (Git Bash):**

```bash
cp -r . "$USERPROFILE/.codex/skills/uv"
```

**Linux/macOS:**

```bash
cp -r . ~/.codex/skills/uv
```
